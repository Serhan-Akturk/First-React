...
function GradeBot(props) {
    ...
    return (
        <div className="my-5">
            ...
            <button className="btn btn-secondary mr-3" onClick={incrementGradeByFive}>Increment Grade by +5</button>
            <button className = "btn btn-danger" onClick={() => setGrade(0)}>Reset</button>
        </div>
    );
}
